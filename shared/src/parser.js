...
exports.validateUnitPath = validateUnitPath;
exports.parseDict = parseDict;
exports.parseFile = parseFile;
const node_fs_1 = require("node:fs");
const js_yaml_1 = __importDefault(require("js-yaml"));
// --- Path safety (SPEC §12) ---
function validateUnitPath(raw) {
    if (!raw)
        return raw;
...
function parseUnit(raw) {
    return {
        ...
        not_for_strict: raw["not_for_strict"] !== undefined ? Boolean(raw["not_for_strict"]) : undefined,
...
function parseContentStructure(raw) {
    if (!raw || typeof raw !== "object" || Array.isArray(raw))
        return undefined;
    const c = raw;
    return {
...
function parseFile(filePath) {
    ...
    const data = js_yaml_1.default.load(raw, { schema: js_yaml_1.default.DEFAULT_SCHEMA });
