...
**Last verified:** WebMCP spec draft 5 March 2026 / KCP v0.8 draft 9 March 2026
...
- Cross-manifest federation (RFC-0003) is proposed but not yet in the core spec
...
| **Current version** | Draft CG Report (5 March 2026) | v0.8 draft (9 March 2026) |
| **Spec completeness** | Imperative API defined; declarative API, security, privacy, accessibility marked TODO | Core spec complete; federation, content integrity, payment details in RFCs |
...
**KCP:**
- [SPEC.md](../../SPEC.md) — normative specification (v0.8)
