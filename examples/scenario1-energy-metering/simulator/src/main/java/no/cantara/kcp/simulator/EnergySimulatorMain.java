...
/**
 * Entry point for Scenario 1: Smart Energy Metering Simulator.
 *
 * <p>Usage:
 * <pre>
 *   java -jar kcp-scenario1-energy-metering-0.1.0-jar-with-dependencies.jar [--auto-approve]
 * </pre>
 */
public final class EnergySimulatorMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GridOrchestratorAgent orchestrator = new GridOrchestratorAgent(log, autoApprove);
    ...
    private static void printUsage() {
        System.out.println("Scenario 1: Smart Energy Metering Simulator");
        System.out.println();
        System.out.println("Usage: java -jar kcp-scenario1-energy-metering-0.1.0-jar-with-dependencies.jar [OPTIONS]");
        System.out.println();
