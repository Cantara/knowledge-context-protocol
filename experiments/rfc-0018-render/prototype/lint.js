// imperative-lint-0.3 — prototype rule set for RFC-0018 §6.2.
//
...
// and experiment B12 documents the bypass.
//
// 0.3: sentence-initial rule matches at line starts (m flag); lintFreeText
// handles string arrays so list-valued free-text fields are linted.
...
/**
 * @param {string|string[]|unknown} text free-text field value
 * @returns {{flagged: boolean, rule?: string}}
 */
export function lintFreeText(text) {
